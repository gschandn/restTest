...
class TransactionServiceTest {
  ...
  @MockBean TransactionDataSource mockDataSource;
  ...
  void makeMultipleDataSourceCalls() {
    ...
    TransactionAmount givenTransaction1 =
        new TransactionAmount(LocalDate.parse("2013-12-21"), BigDecimal.valueOf(1000));
    TransactionAmount givenTransaction2 =
        new TransactionAmount(LocalDate.parse("2013-12-21"), BigDecimal.valueOf(2000.51));
    TransactionAmount givenTransaction3 =
        new TransactionAmount(LocalDate.parse("2013-12-22"), BigDecimal.valueOf(10));
    TransactionAmount givenTransaction4 =
        new TransactionAmount(LocalDate.parse("2013-12-23"), BigDecimal.valueOf(1.49));
    TransactionAmount givenTransaction5 =
        new TransactionAmount(LocalDate.parse("2013-12-23"), BigDecimal.valueOf(0));
    ...
    Mockito.when(mockDataSource.getTransactionsByPage(2)).thenReturn(givenTransactionWrapper2);
  ...
  void propagateRestClientException() {
    assertNotNull(mockDataSource);
    // when
    Mockito.when(mockDataSource.getTransactionsByPage(1)).thenThrow(RestClientException.class);
    // then
    Assertions.assertThrows(
        RestClientException.class, () -> transactionService.getRunningBalances());
  }
}
